...
To check if an asset is stationary - "invariant" - use `invariance_test:`
...
If the two pieces of the distribution are statistically different among themselves a Bayesian estimation technique may be recommended in the next step of the Checklist: **Estimation**.
